...
public class InvoiceTest {
	...
	public void testCostCalculation() {
		...
		Supplier supplier = new Supplier("supplier 1", "supplier@gmail.com",
				"supplier street", "489702987");
		...
		Product product1 = new Product(p1name, p1cost, p1markup, p1stockLevel,
				supplier);
		Product product2 = new Product(p2name, p2cost, p2markup, p2stockLevel,
				supplier);
		...
		Customer customer = new Customer("cutomer", "89437628",
				"customer@gmail.com", "customer street");
