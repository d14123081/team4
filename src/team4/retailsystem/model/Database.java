...
public class Database {
	...
	void generateProducts() {
		addProduct(new Product(500.00, 10, "iPhone 5s", 600.00, 0, suppliers.get(0)));
		addProduct(new Product(250.00, 5, "iPhone 4", 300.00, 0, suppliers.get(0)));
		addProduct(new Product(480.00, 10, "Galaxy S5", 550.00, 0, suppliers.get(1)));
	}
	...
	void generateDeliveries() {
		addDelivery(new Delivery(suppliers.get(0), orders.get(0))); //first delivery from apple 10 iphone 5s, 5 iphone 4
		addDelivery(new Delivery(suppliers.get(1), orders.get(1))); //second delivery from samsung 20 S5
	}
